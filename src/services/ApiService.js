...
export async function edit(userDTO) {
  //info edit
  return call_var("/auth/edit", "PUT", userDTO).then((response) => {
    //로컬 스토리지에 토큰 삭제
...
export async function getUserInfo(userDTO) {
  // 새로운 API 엔드포인트를 사용해서 사용자 정보를 가져오도록 설정
...
export async function getTopRatedMovie() {
  return call_var("/MovieSelectDESCRating", "GET")
    .then((response) => {
      return response.json();
    })
    .catch((error) => {
...
export async function getTopReservationMovie() {
  return call_var("/NowMovieSelectDESCReserveRate", "GET")
    .then((response) => {
      return response.json();
    })
    .catch((error) => {
...
// 선호 장르 영화 조회 (모든 영화)
export async function getGenreRecommendMovie(genre) {
  return call_var(`/MovieSelectByGenre/${genre[0]}/${genre[1]}`, "GET")
    .then((response) => {
      return response.json();
    })
    .catch((error) => {
...
// 선호 배우 출연작 조회 (모든 영화)
export async function getActorRecommendMovie(actor) {
  return call_var(`/MovieSelectByActor/${actor}`, "GET")
    .then((response) => {
      return response.json();
    })
    .catch((error) => {
