    ...
    <div className="flex h-screen justify-center items-center dark:text-white mt-4">
      <div className="w-10/12 border border-gray-300 p-4 rounded-lg">
        <div className="flex flex-col items-center">
          <FaUserEdit color="#CA3A31" className="text-6xl ml-4" />
          <p className="mt-2 text-2xl font-bold">회원정보수정</p>
        </div>
        <form onSubmit={handleSubmit}>
          <div className="mt-4 flex flex-col items-center">
            <div className="flex flex-row items-center">
              ...
              <input
                className="pl-2 border-red-600 dark:bg-gray-500
          ...
          <div className="flex flex-row justify-center">
            <button
              type="submit"
              className="mt-4 dark:text-white bg-red-600 rounded-md
              p-2 w-1/3 font-bold mx-1 max-w-[25%] "
            >
              수정
            </button>
            <Link
              to="/mypage"
              className="mt-4 dark:text-white bg-red-600 rounded-md
              p-2 w-1/3 font-bold text-center mx-1 max-w-[25%] "
            >
              취소
            </Link>
          </div>
